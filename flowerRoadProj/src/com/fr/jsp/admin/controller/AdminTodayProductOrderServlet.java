...
public class AdminTodayProductOrderServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 등록된 모든 상품 리스트
		ArrayList<AdminProduct> admin_allProductList = ps.admin_allProductList();
		// 상품 카테고리 리스트
		...
		// 발주 현황 리스트
		ArrayList<AdminProductOrder> admin_todayProductOrderList = ps.admin_todayProductOrderList();
